...
import { Octokit } from "https://cors-anywhere.herokuapp.com/https://esm.sh/octokit";
...
function loadToPanel(ghCmsId){
  if ($('.'+ghCmsId).length != 1){alert('Impossible de modifier cette page, envoyer un mail à dev@chapelmele.com avec son lien et le plus d\'infos possible'); return}
